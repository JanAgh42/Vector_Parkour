class GameOverMenu extends Node{
    ...
    createNodes(){
        this.add(new Button(400, 400, 180, 60, '#psett', this.ctx), 'listOfNodes');
    }
    ...
    draw(){
        ...
        this.ctx.drawImage(this.end, 300, 100, 400, 70);
        ...
        if(this.game.settings.sounds){
            this.game.sounds.gameover.playAudio();
        } 
    }
}